                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 items-center'>
                    ...
                    <div className='text-left flex flex-col items-start '>
                        ...
                        <div className='flex gap-4 items-center mt-6'>
                            ...
                            className='uppercase paragraph-font py-3 px-8 border border-black text-sm   bg-white/90 text-black transition-all duration-300 hover:bg-amber-500 hover:text-white hover:border-white '>
                                Explore collections</button>
                            <button 
                            onClick={()=>navigate('/booking')}
                            className='uppercase paragraph-font py-3 px-8 border border-white text-sm bg-transparent text-white transition-all duration-300 hover:text-amber-500 hover:border-amber-500'>
