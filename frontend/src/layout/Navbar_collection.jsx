...
import { NAVBAR } from '../data/collectionConstants.js'
import { MenuIcon, X } from 'lucide-react'
import { NAV_LINKS } from '../data/constants.js' 


const Navbar_collection = () => {
    ...
    return (
        <nav className={`fixed top-0  right-0 left-0 z-100 py-1 bg-none border-b border-transparent transition-all duration-200 ${isScroll
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div >
                        ...
                        <button
                            ...
                            className=' p-4 text-white/50 hover:text-white/60 '
                        >
            ...
            {/* mobile navbar  */}
            <div className={` transition-all duration-300 overflow-hidden bg-none ${isMenuOpen
...
export default Navbar_collection