...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 right-0 left-0 z-100 py-1 bg-none transition-smooth ${isScroll
      ? ' bg-black '
      : ' bg-black'
      }`}>
      <div className='max-w-330 mx-auto px-5'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-1'>
            ...
            <img src={MAIN_INFO.logo} alt="logo_image" className='w-15 h-15 rounded-2xl' />
